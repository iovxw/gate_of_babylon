...
translate([0,0,0]) rotate(a=[0,0,0]) knurl(k_cyl_hg	= 7.5+7, k_cyl_od = 14, s_smooth=50);

translate([0,0,20+7+2.3]) rotate(a=[0,0,0]) sphere(16,$fn=100);

// knob cutout
translate([0,0,-0.1]) rotate(a=[0,0,0]) cylinder(h = 4.6+7, d=6.1, $fn=60);
    
translate([0,0,-0.1]) rotate(a=[0,0,0]) cylinder(h = 0.6, d1=7.1, d2=6.1 , $fn=30); 
    
translate([0,0.75,-0.1]) rotate(a=[0,0,-90]) cube([1.5,5.3,4.6+7]);
...
translate([0,0,1]) rotate(a=[0,0,0]) cylinder(h = 2,d= 13, $fn=30);
    translate([-13.5,-6,-0.1]) rotate(a=[0,0,0]) cube([10,12,4.6+7]);
}
}      
...
translate([0,0,-0.1]) rotate(a=[0,0,0]) cylinder(h = 4.6+7, d=11, $fn=60);
translate([0,0,-0.1]) rotate(a=[0,0,0]) cylinder(h = 4.6+7, d= 10, $fn=60);
translate([-13.5,-6,-0.1]) rotate(a=[0,0,0]) cube([10,12,4.6+7]);
